...
export default function StudentProfilePage() {
  ...
  async function loadProfile() {
    try {
      setLoading(true);
      const data = await apiFetch<StudentProfile>('/alunos/me');
      setName(data.name || '');
      setEmail(data.email || '');
      ...
      setFeedback({
        type: 'error',
        text: err instanceof Error ? err.message : 'Erro ao carregar dados do perfil.',
      });
    } finally {
      setLoading(false);
    }
  ...
  async function handleUpdateProfile(e: FormEvent) {
    ...
    try {
      await apiFetch<StudentProfile>('/alunos/me', {
        method: 'PUT',
        body: JSON.stringify({
          name,
          email,
      ...
      setFeedback({
        type: 'error',
        text: err instanceof Error ? err.message : 'Não foi possível atualizar o perfil.',
      });
    } finally {
      setSaving(false);
    }
  ...
  async function handleChangePassword(e: FormEvent) {
    ...
    try {
      await apiFetch('/alunos/me/password', {
        method: 'PATCH',
        body: JSON.stringify({
          currentPassword,
          newPassword,
      ...
      setFeedback({
        type: 'error',
        text: err instanceof Error ? err.message : 'Erro ao alterar a senha. Verifique a senha atual.',
      });
    } finally {
