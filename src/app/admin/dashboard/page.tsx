  ...
  async function loadDashboardStats() {
    try {
      ...
      const [books, students, categories, reservations, waitingList] = await Promise.all([
        apiFetch<unknown[]>('/livros').catch(() => []),
        apiFetch<unknown[]>('/alunos').catch(() => []),
        apiFetch<unknown[]>('/categorias').catch(() => []),
        apiFetch<unknown[]>('/reservas').catch(() => []),
        apiFetch<unknown[]>('/fila-espera').catch(() => []),
      ]);
